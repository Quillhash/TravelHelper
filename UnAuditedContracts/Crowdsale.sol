...
contract Crowdsale is Ownable {
  ...
  uint public preSaleDuration = 10; // this value is for testing only actual value  will be  = (7 days)/(15);
  uint public discountedSaleDuration = 10; //this value is for testing only actual value will be  = (15 days)/(15); 
  uint public mainSaleDuration = 10; //this value is for testing only actual value will be  = (15 days)/(15); 
...
/**
 ...
 function setEthPriceInDollar(uint _ethPriceInCents) onlyOwner public returns(bool) {
   ...
   */
    ...
    function finalizeAndBurn() public onlyOwner {
